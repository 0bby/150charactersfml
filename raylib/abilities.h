...
static const AbilityDef ABILITY_DEFS[ABILITY_COUNT] = {
    [ABILITY_MAGIC_MISSILE] = {
        ...
        .values = {
            { [AV_MM_DAMAGE]=0.20f, [AV_MM_STUN_DUR]=1.0f, [AV_MM_PROJ_SPEED]=60.0f },
            { [AV_MM_DAMAGE]=0.28f, [AV_MM_STUN_DUR]=1.25f,[AV_MM_PROJ_SPEED]=60.0f },
            { [AV_MM_DAMAGE]=0.36f, [AV_MM_STUN_DUR]=1.5f, [AV_MM_PROJ_SPEED]=60.0f },
            { [AV_MM_DAMAGE]=0.45f, [AV_MM_STUN_DUR]=1.75f,[AV_MM_PROJ_SPEED]=60.0f },
            { [AV_MM_DAMAGE]=0.55f, [AV_MM_STUN_DUR]=2.0f, [AV_MM_PROJ_SPEED]=60.0f },
        },
    },
    [ABILITY_DIG] = {
    ...
    [ABILITY_VACUUM] = {
        ...
        .values = {
            ...
            { [AV_VAC_RADIUS]=36.0f, [AV_VAC_STUN_DUR]=1.0f, [AV_VAC_PULL_DUR]=0.5f },
            { [AV_VAC_RADIUS]=42.0f, [AV_VAC_STUN_DUR]=1.3f, [AV_VAC_PULL_DUR]=0.5f },
            { [AV_VAC_RADIUS]=50.0f, [AV_VAC_STUN_DUR]=1.6f, [AV_VAC_PULL_DUR]=0.5f },
            { [AV_VAC_RADIUS]=60.0f, [AV_VAC_STUN_DUR]=2.0f, [AV_VAC_PULL_DUR]=0.5f },
        },
    },
    [ABILITY_CHAIN_FROST] = {
    ...
    [ABILITY_STONE_GAZE] = {
        ...
        .values = {
            { [AV_SG_GAZE_THRESH]=3.0f, [AV_SG_STUN_DUR]=1.0f, [AV_SG_DURATION]=5.0f, [AV_SG_CONE_ANGLE]=35.0f },
            { [AV_SG_GAZE_THRESH]=2.6f, [AV_SG_STUN_DUR]=1.2f, [AV_SG_DURATION]=6.0f, [AV_SG_CONE_ANGLE]=35.0f },
            { [AV_SG_GAZE_THRESH]=2.2f, [AV_SG_STUN_DUR]=1.5f, [AV_SG_DURATION]=7.0f, [AV_SG_CONE_ANGLE]=40.0f },
            { [AV_SG_GAZE_THRESH]=1.8f, [AV_SG_STUN_DUR]=1.8f, [AV_SG_DURATION]=8.0f, [AV_SG_CONE_ANGLE]=45.0f },
            { [AV_SG_GAZE_THRESH]=1.4f, [AV_SG_STUN_DUR]=2.2f, [AV_SG_DURATION]=10.0f,[AV_SG_CONE_ANGLE]=50.0f },
        },
    },
    [ABILITY_SUNDER] = {
