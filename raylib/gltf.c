...
int main(void)
{
    ...
    // Load model
    Model model = LoadModel("assets/goblin/animations/PluginGoblinWalk.glb");
    Vector3 position = { 0.0f, 0.0f, 0.0f }; // Set model world position

    // Load model animations
    int animCount = 0;
    ModelAnimation *anims = LoadModelAnimations("assets/goblin/animations/PluginGoblinWalk.glb", &animCount);
