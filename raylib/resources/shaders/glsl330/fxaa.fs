...
void main() {
    ...
    vec3 rgbNW = texture(texture0, fragTexCoord + vec2(-1.0, -1.0) * texcoordOffset).rgb;
    vec3 rgbNE = texture(texture0, fragTexCoord + vec2(1.0, -1.0) * texcoordOffset).rgb;
    vec3 rgbSW = texture(texture0, fragTexCoord + vec2(-1.0, 1.0) * texcoordOffset).rgb;
    vec3 rgbSE = texture(texture0, fragTexCoord + vec2(1.0, 1.0) * texcoordOffset).rgb;
